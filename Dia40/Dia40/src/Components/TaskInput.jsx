...
import TaskList from './TaskList'; // Importando o componente de lista
...
function TaskInput() {
  ...
  const handleDeleteTask = (taskIndex) => {
    ...
    setTasks(updatedTasks); // Atualiza o estado removendo a tarefa correspondente
  };
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-lg p-6 bg-white rounded-xl shadow-2xl transform hover:shadow-3xl transition-shadow duration-300 ease-in-out">
        ...
        {/* Passando as tarefas e a função de deletar para o componente TaskList */}
